...
public class DatabaseUpdaterGen extends SQLiteAssetHelper {
    ...
    public DatabaseUpdaterGen(Context context) {
    ...
    public void updateDetails() {
        ...
        String[] sqlSelect = {"track_id", "title", "artist_name", "overall_ranking"};
    ...
    public String getArtistID() {
        ...
        String[] sqlSelect = {"artist_id", "overall_ranking"};
        String sqlTable = "songs";
        String orderBy = "overall_ranking DESC";
    ...
    public double getAvgArtistRating() {
        ...
        String[] sqlSelect = {"artist_id", "avg(Rating)", "overall_ranking"};
        String sqlTable = "songs";
    ...
    public void updateArtistRanking() {
        ...
        String[] sqlSelect = {"artist_id", "artist_ranking"};
        String sqlTable = "songs";
    ...
    public String getTerm() {
        ...
        String where = "s.artist_id = '" + artistID + "'"; // this is where we will pass in
    ...
    public double getAvgTermRating() {
        ...
        if(term.equals("blank")){
            ...
            String orderBy = "s.artist_ranking DESC";
